...
class WebSearch(BaseTool):
    ...
    if GoogleSearchEngine is not None:
        _search_engine["google"] = GoogleSearchEngine()
    if DuckDuckGoSearchEngine is not None:
        _search_engine["duckduckgo"] = DuckDuckGoSearchEngine()
    if BingSearchEngine is not None:
        _search_engine["bing"] = BingSearchEngine()
    if BaiduSearchEngine is not None:
        _search_engine["baidu"] = BaiduSearchEngine()
